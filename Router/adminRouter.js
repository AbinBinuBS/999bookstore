...
admin_route.get(
  "/Unactive-user",
  adminAuth.isLogin,
  adminController.uactiveList
);

admin_route.post(
  "/blockCustomer",
  adminAuth.isLogin,
  adminController.customerBlock
);

admin_route.get(
  "/product",
  adminAuth.isLogin,
  adminController.productManagement
);
...
admin_route.get(
  "/category",
  adminAuth.isLogin,
  adminController.categoryManagement
);
admin_route.post(
  "/add-category",
  adminAuth.isLogin,
...
admin_route.get(
  "/editCoupon",
  adminAuth.isLogin,
  adminController.loadEditCoupon
);
...
admin_route.post(
  "/addbanner",
  adminAuth.isLogin,
  bannerUplods.array("image", 5),
  adminController.addBanner
);
admin_route.post(
  "/updateBannerStatus",
  adminAuth.isLogin,
  adminController.blockBanner
);
admin_route.get(
  "/editBanner",
  adminAuth.isLogin,
  adminController.loadEditBanner
);
admin_route.post(
  "/editBanner",
  adminAuth.isLogin,
