...
user_route.post('/applycoupon',userController.applycoupons)
user_route.post('/couponCheck',userController.pushingCoupon)
user_route.post('/onlinepayment',userController.onlinePay)
user_route.post('/walletpayment',userController. walletPayment)
user_route.post('/proceedtoPayment',auth.isLogin,userController.paymentManagement)
